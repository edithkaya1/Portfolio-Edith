        ...
        $cards .= "<div>
               <div class='card mx-auto my-3'>
                  ...
                  <div class='text-center'>
                   ...
                   <div class='card-body'>
                    <p class='card-text fw-bold text-center'>Breed: {$row['name']}</p>
                   ...
                   <div class='text-center'>
                    ...
                    <a href='adopting.php?id=$row[id]' class='{$buttonDisablen} btn btn-warning btn-lg text-center mx-4 my-3'>Take me home</a> 
...
<head>
    ...
    <style>
        ...
        .header2 {
            ...
            font-style: normal;
            color: #c70054;
            text-shadow: 6px 6px 0 lightgray;
            animation: flash;
            animation-duration: 5s;
            --animate-delay: 0.9s;
        }
...
<body>
    ...
    <div class="container-fluid bg-image">
        <h1 class="header1 text-center fw-bold">Welcome to pet adoption Breitenfurt</h1>

        <div class="container-fluid hero">
            <img src="https://cdn.pixabay.com/photo/2014/10/30/10/05/dog-509103_1280.jpg" alt="Description">
