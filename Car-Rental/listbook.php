...
$sql = "SELECT * FROM booking INNER JOIN users ON booking.fk_user_id = users.id INNER JOIN cars ON booking.fk_cars_id = cars.id where booking.fk_user_id = {$_SESSION["user"]} ORDER BY booking.pickup_date";
// print_r($sql);
        ...
        $cards .= "<div>
               <div class='card mx-auto my-3'>
                   ...
                   <div class='text-center'>
                      <img src='pictures/{$row["picture"]}' class='card-image-top' alt='{$row["picture"]}'>
                   </div>
                   <div class='card-body'>
                    <p class='card-title fw-bold text-center'>Pickup date: {$pdate}</p>
                    <p class='card-title fw-bold text-center'>Pickup time: {$ptime}</p>
                    <p class='card-title fw-bold text-center'>Return date: {$rdate}</p>
                    <p class='card-title fw-bold text-center'>Return time: {$rtime}</p>
                   </div>
                    <div class='text-center'>
...
<body>
    ...
    <div class="container-fluid bg-image">
        <h1 class="header1 text-center fw-bold">List of bookings</h1>
