    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse p-3" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link" href="listbook.php">User bookings</a>
        </div>
      </div>
    </div>
  </nav>

  <div class="container-flui bg-image">
    ...
    <div class="container-fluid hero">
      ...
      <p class="text1">Renting a car has never been so easy. We have a large selection of vehicles in all categories.
        With us, you
        don't have to stand in line. Register on our website and let the fun begin. For a rental car from <strong>Car
          Rental Fritz</strong>, you don't need any paperwork or pick-up times. With our transparent pricing, you can
        rent a car for as
    ...
    <h1 class="header1 text-center fw-bold">List of cars to rent</h1>
    ...
    <br>
    <div class="text-center">
      <a href='create.php' id="neonShadow">Create a new car</a>
      <!-- <a href='create.php' class='btn btn-outline-warning btn-lg text-center my-3'>Create new dish</a> -->
      <br>
      <br>
      <br>
    </div>
