...
if (isset($_POST["create"])) {
  ...
  // fileUpload($_FILES['picture'], 'user')
  ...
  $sql = "INSERT INTO `cars`(`brand`, `model`, `type`, `color`, `transmission`, `price_day`, `price_hour`, `price_minute`, `description`, `picture`, `top_speed`, `status`) VALUES 
  ('$brand','$model','$type','$color','$transmission','$dprice','$hprice','$mprice','$description','$picture[0]',$tspeed, '$status')";
  if (mysqli_query($connect, $sql)) {
    echo "<div class='alert alert-success' role='alert'>
           New car has been successfully created, {$picture[1]}
         </div>";
  } else {
  ...
  <div class="container-fluid bg-image">
    <div class="row">
      <div class="col col-md-6 mx-auto my-3">
        <h3 class="text-center header1 fw-bold">Create a new car</h3>
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="type" aria-describedby="type" name="type"
              placeholder="Enter cartype" required>
          </div>
          <div class="mb-3 mt-3">
          ...
          <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="transmission" aria-describedby="transmission"
              name="transmission" placeholder="Enter transmission" required>
          </div>
          <div class="mb-3">
            <label for="price_day" class="text1 form-label">Price per day</label>
            <input type="double" class="form-control" id="price_day" aria-describedby="price_day" name="price_day"
              placeholder="Enter price per day" required>
          </div>
          <div class="mb-3">
            <label for="price_hour" class="text1 form-label">Price per hour</label>
            <input type="double" class="form-control" id="price_hour" aria-describedby="price_hour" name="price_hour"
          ...
          <div class="mb-3">
            ...
            <input type="double" class="form-control" id="price_minute" aria-describedby="price_minute"
              name="price_minute" placeholder="Enter price per minute" required>
          </div>
          <div class="mb-3 mt-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="top_speed" aria-describedby="top_speed" name="top_speed"
              placeholder="Enter topspeed" required>
          </div>
          <div class="mb-3">
          ...
          <div class="text-center">
            <button name="create" type="submit" class="btn btn-lg btn-outline-secondary mx-5">Save car</button>
